!===============================================================================
! File: mod_okada_dc3d_include.f90
! Purpose: Include file containing DC3D subroutines from Okada (1985)
! Note: This file contains the complete DC3D implementation extracted from DC3D.txt
!===============================================================================

! Include all subroutines from DC3D.txt (lines 471-1145)
! These will be compiled as part of the mod_okada_dc3d module

! The following subroutines are defined:
! - DC3D: Main finite fault calculation
! - UA, UB, UC: Displacement calculation parts
! - DCCON0, DCCON1, DCCON2: Geometry constant calculations
