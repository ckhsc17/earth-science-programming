program seismic_waveform_plot
  ...
  ! ---- Initialize PGPLOT ----
  if (pgopen('seismic_waveform.ps/vcps') <= 0) then
  ...
  call pgenv(t_min, t_max, acc_min, acc_max, 0, 1)
  ...
  write(*,*) 'gs -dBATCH -dNOPAUSE -sDEVICE=pdfwrite -sOutputFile=seismic_waveform.pdf seismic_waveform.ps'
